...
/* MARK: Variables */
@mixin super-app-light {
  --component-app-bar-background: #00252e;
  --component-shortcut-card-background: #00ae9d;
  --component-shortcut-card-text: #ffffff;
  --component-swap-account-background: #058075;
  ...
  --color-function-tertiary-lightest: #1de4c9;
  ...
  --opacity-base: 8;
  --shadow-primary: 0px 0px 8px 0 rgba(0, 174, 157, 0.8);
