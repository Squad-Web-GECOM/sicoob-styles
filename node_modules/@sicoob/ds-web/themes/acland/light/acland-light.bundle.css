...
:before {
  ...
  --box-shadow-action: 0px 0px 1px 0 rgba(0, 30, 36, 0.24),
    0px 2px 1px 1px rgba(0, 30, 36, 0.24);
  --box-shadow-action-inset: 0px 2px 1px 0 rgba(0, 30, 36, 0.24) inset,
    0px 0px 1px 0 rgba(0, 0, 0, 0.25);
  --box-shadow-surface: 0px 0px 1px 0 rgba(0, 30, 36, 0.24),
    0px 2px 2px 0 rgba(0, 30, 36, 0.24);
  --box-shadow-surface-inset: 0px 2px 2px 0 rgba(0, 30, 36, 0.24) inset,
    0px 0px 1px 0 rgba(0, 30, 36, 0.25);
  --box-shadow-surface-action: 0px 4px 8px 0 rgba(0, 30, 36, 0.24),
    0px 0px 1px 0 rgba(0, 30, 36, 0.24);
  --box-shadow-overlay: 0px 12px 24px 0 rgba(0, 30, 36, 0.24),
    0px 0px 1px 0 rgba(0, 30, 36, 0.24);
  --box-shadow-fixed-bottom: 0px 1px 2px 0 rgba(0, 30, 36, 0.24);
  --box-shadow-fixed-top: 0px -1px 2px 0 rgba(0, 30, 36, 0.08);
  --box-shadow-fixed-right: 1px 0px 2px 0 rgba(0, 30, 36, 0.08);
  --box-shadow-fixed-left: -1px 0px 2px 0 rgba(0, 30, 36, 0.08);
